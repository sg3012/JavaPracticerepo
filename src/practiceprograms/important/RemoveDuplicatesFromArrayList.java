...
public class RemoveDuplicatesFromArrayList {
	...
	public static ArrayList<Integer> removeDuplicates(ArrayList<Integer> arrayList) {
		...
		// addAll() method allows one collection to be inserted in an empty collection
		// or appended to a non-empty collection
		set.addAll(arrayList);

		// clear() method removes all elements from a collection
		// so, this method call will remove all elements from the
		// original ArrayList called "arrayList".
		arrayList.clear();

		// Again calling addAll() method of
		// ArrayList to fill all the elements from
		// the set to the original empty list again
