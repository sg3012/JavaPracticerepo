...
//		while (temp != 0) {
//			remainder = temp % 10; // typecasting the obtained long remainder
//											// value in int because remainder is an int value
//			sum = sum + remainder;
//			temp = temp / 10;
//			// if at any point while calculating the sum of 
//			// individual digits of the number comes out to be zero
//			if (temp == 0) {
//				// Then come inside if condition
//				// and check whether the sum of the indivual
//				// digits was > 9 or not
//				if (sum > 9) {
