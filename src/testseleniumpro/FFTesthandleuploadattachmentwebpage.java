...
public class FFTesthandleuploadattachmentwebpage {
    ...
    launchfirefox.get("https://html.com/input-type-file/");
    launchfirefox.findElement(By.xpath("//*[@id=\"fileupload\"]")).sendKeys("C:\\Users\\ShubhamQA\\Downloads\\jobOutput.txt");
	}
